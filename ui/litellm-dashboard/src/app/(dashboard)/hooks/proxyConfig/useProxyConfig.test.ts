...
describe("useProxyConfig", () => {
	...
	it("should return proxy config data when query is successful", async () => {
		...
		expectSessionFetchCall(fetchSpy, `${mockProxyBaseUrl}/config/list?config_type=${ConfigType.GENERAL_SETTINGS}`, {
			method: "GET",
		});
...
describe("useDeleteProxyConfigField", () => {
	...
	it("should successfully delete a proxy config field", async () => {
		...
		expectSessionFetchCall(fetchSpy, `${mockProxyBaseUrl}/config/field/delete`, {
			method: "POST",
