...
const ChatUI: React.FC<ChatUIProps> = ({
	...
	// MCP administration always uses the current UI session.
	const loadServerTools = React.useCallback(
	...
	useEffect(() => {
		...
		loadMCPServers();
	}, [accessToken, userID, userRole, token, simplified, loadMCPServers, selectedModel]);
	...
	}, [endpointType, loadServerTools, selectedMCPServers, serverToolsMap]);
