...
export function GuardrailsOverview({
	...
	const activeData: PerformanceRow[] = React.useMemo(() => guardrailsData?.rows ?? [], [guardrailsData?.rows]);
		...
		<div>
			...
			<Card className="bg-white border border-gray-200 rounded-lg">
				...
				<div className="px-6 py-4 border-b border-gray-200 flex items-start justify-between gap-4">
					<div>
						<Title className="text-base font-semibold text-gray-900">Guardrail Performance</Title>
