...
describe("KeyInfoView", () => {
	...
	it("should not render tags in metadata textarea", async () => {
		...
		await waitFor(() => {
			...
			const metadataBlock = document.querySelector("pre");
	...
	it("should close through the Drawer without rendering a Back to Keys control", async () => {
		vi.mocked(useAuthorized).mockReturnValue(baseUseAuthorizedMock);
	...
	describe("Drawer title Edit action", () => {
		...
		it("should show the Edit button when the user is a proxy admin for a key they do not own", async () => {
			vi.mocked(useAuthorized).mockReturnValue({
				...baseUseAuthorizedMock,
		...
		it("should show the Edit button when the user is the key owner", async () => {
			vi.mocked(useAuthorized).mockReturnValue({
				...baseUseAuthorizedMock,
				userId: "owner-user-id",
		...
		it("should not show the Edit button when an Internal User does not own the key", async () => {
			vi.mocked(useAuthorized).mockReturnValue({
				...baseUseAuthorizedMock,
		...
		it("should not show the Edit button when the user is an Internal Viewer even if they own the key", async () => {
			vi.mocked(useAuthorized).mockReturnValue({
				...baseUseAuthorizedMock,
				userId: "owner-user-id",
				userRole: "Internal Viewer",
		...
		it("should show the Edit button when the user is a team admin for the key's team", async () => {
			const teamId = "test-team-id";
			const teamAdminUserId = "team-admin-user";
			vi.mocked(useTeams).mockReturnValue({
				teams: [
