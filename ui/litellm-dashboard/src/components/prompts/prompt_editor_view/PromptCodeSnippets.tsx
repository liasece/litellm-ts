...
main();`;
	...
	}, [apiBase, effectiveApiKey, model, promptId, promptVariables, selectedLanguage, selectedTab, version]);
	...
	}, [isModalVisible, selectedLanguage, selectedTab, promptId, model, promptVariables, generateCode]);
