...
import { DeploymentHealthStatus } from "./useDeploymentHealth";
...
type HealthStatus = DeploymentHealthStatus;
	...
	},
	{
		...
		cell: ({ row }) => {
			...
			const hasSuccessResponse =
				healthStatus.status === "healthy" && Boolean(modelHealthStatuses[modelId]?.successResponse);
