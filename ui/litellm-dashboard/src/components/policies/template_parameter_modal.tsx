...
const TemplateParameterModal: React.FC<TemplateParameterModalProps> = ({
	...
	const parameters: TemplateParameter[] = React.useMemo(() => template?.parameters || [], [template?.parameters]);
	...
	}, [availableModels.length, competitorMode, hasEnrichment, loadModels, visible]);
