...
describe("CreateMCPServer", () => {
	...
	describe("when HTTP transport is selected", () => {
		...
		it("should not require auth value when creating a server with API Key auth type", { timeout: 15000 }, async () => {
			await selectHttpTransport();
		...
		it("should successfully create a server when auth value is provided", { timeout: 15000 }, async () => {
			await selectHttpTransport();
		...
		it("should successfully create a server with no auth", { timeout: 15000 }, async () => {
			await selectHttpTransport();
