					...
					>
						<div className="flex items-center justify-between gap-2">
							...
							<div
								...
								className={`resizer absolute right-0 top-0 h-full w-[5px] cursor-col-resize touch-none select-none group-hover:opacity-50 ${
									resizeDirection
								} ${resizing ? "bg-blue-500 opacity-100" : "bg-transparent opacity-0"}`}
							/>
						</div>
					</TableHeaderCell>
				);
